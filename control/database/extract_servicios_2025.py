...
OUTPUT_SQL = '/Users/sebastianretamozo/Documents/IO_Group_Web-main/control/database/migrations/import_servicios_2025.sql'
...
def parse_pagos():
    ...
    for sheet_name in wb_pagos.sheetnames:
        ...
        for r_idx in range(headers_row + 1, ws.max_row + 1):
            ...
            if not isinstance(val_fserv, datetime.datetime) or val_fserv.year != 2025:
                continue
